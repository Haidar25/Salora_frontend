                    ...
                    <a href="/" style=" background-color: #f44336; color: white; padding: 14px 25px; text-align: center; text-decoration: none; display: inline-block; " class="f-w-600 p-l-5"> Kembali ke Home</a>
						...
						<div class="login-card card-block bg-white" style="border-radius: 90px 40px;">
                            <form class="md-float-material" action="/register" method="POST">
                                ...
                                <h3 class="text-center txt-primary">Buat akun disini </h3>
                                ...
                                @endif
                                    ...
                                    <!-- <div class="form-group">
                                            <label>No HP</label>
										<input type="number" class="md-form-control" required="" name="phone">
                                    </div> -->
                                    <div class="form-group">
									...
									<div class="form-group">
										...
										<input type="password" id="password" class="md-form-control" required autocomplete="new-password" class="form-control @error('password') is-invalid @enderror" name="password">
									</div>
